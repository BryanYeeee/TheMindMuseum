...
export default function UI({
    ...
    return (
        <div className="fixed inset-0 pointer-events-none select-none font-lora text-white z-50">
                        ...
                        <div className="absolute bottom-8 left-10 flex flex-col gap-2">
                            {[
                                ...
                                <div
                                    ...
                                    <span className="text-[9px] text-white/50 tracking-[0.2em] uppercase w-16">
                                        {label}
                                    </span>
                                    <span className="text-[10px] text-white/90 tracking-widest border border-white/40 px-2 py-0.5">
                                        {key}
                                    </span>
                                </div>
                            ))}
            ...
            <AnimatePresence>
                {receptionistOpen && (
                    <ReceptionistChat onClose={onCloseReceptionist} />
                )}
            </AnimatePresence>

            {/* BOTTOM RIGHT: LOCATION */}
            <div className="absolute bottom-8 right-10 flex items-center gap-3">
                <span className="text-[9px] text-white/50 tracking-[0.2em] uppercase">
                    Location
                </span>
